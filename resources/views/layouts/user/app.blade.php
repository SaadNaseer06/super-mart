...
<body class="ecommerce">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 additional-nav">
                    <ul class="list-unstyled list-inline pull-right">
                        <li><a href="">Hi, {{ Auth::guard('web')->user()->name }}</a></li>
                        ...
                        <li>
                            <form action="/logout" method="POST">
                                @csrf
                                <button class="btn btn-secondary btn-sm fw-bold" type="submit" style="height: 30px">
                                    <p>Logout</p>
                                </button>
                            </form>
                        </li>
    ...
    <div class="header">
        <div class="container">
            <a class="site-logo" href="/"><img src="/assets/corporate/img/logos/logo-shop-red.png"
                    ...
                    <div class="top-cart-content">
                        <ul class="scroller" style="height: 250px;">
                            @foreach ($carts as $cart)
                                <li>
                                    <a href="/cart"><img src="/products/{{ $cart->image }}" width="37"
                                            height="34"></a>
                                    <span class="cart-content-count">x {{ $cart->quantity }}</span>
                                    <strong><a href="/cart">{{ $cart->name }}</a></strong>
                                    <em>${{ $cart->price * $cart->quantity }}</em>
                                    <div class="">
                                ...
                                <div class="header-navigation-content">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 nav-brands">
                                            <ul>
                                                <li><a href="shop-product-list.html"><img title="esprit"
                                                            alt="esprit"
                                                            src="/assets/pages/img/brands/esprit.jpg"></a></li>
                                                <li><a href="shop-product-list.html"><img title="gap"
                                                            alt="gap" src="/assets/pages/img/brands/gap.jpg"></a>
                                                </li>
                                                <li><a href="shop-product-list.html"><img title="next"
                                                            alt="next"
                                                            src="/assets/pages/img/brands/next.jpg"></a></li>
                                                <li><a href="shop-product-list.html"><img title="puma"
                                                            alt="puma"
                                                            src="/assets/pages/img/brands/puma.jpg"></a></li>
                                                <li><a href="shop-product-list.html"><img title="zara"
                                                            alt="zara"
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 pre-footer-col">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam sit nonummy nibh euismod
                        tincidunt ut laoreet dolore magna aliquarm erat sit volutpat. Nostrud exerci tation
                ...
                <div class="col-md-3 col-sm-6 pre-footer-col">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><i class="fa fa-angle-right"></i> <a href="javascript:;">Shipping &amp; Returns</a>
                        </li>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4">
                    <ul class="list-unstyled list-inline pull-right">
                        ...
                        <li><img src="/assets/corporate/img/payments/american-express.jpg"
                        ...
                        <li><img src="/assets/corporate/img/payments/PayPal.jpg" alt="We accept PayPal"
                                title="We accept PayPal"></li>
                        <li><img src="/assets/corporate/img/payments/visa.jpg" alt="We accept Visa"
