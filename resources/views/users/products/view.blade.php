            ...
            <div class="row margin-bottom-40">
                        ...
                        <li class="list-group-item clearfix dropdown active">
                            ...
                            <ul class="dropdown-menu" style="display:block;">
                                <li class="list-group-item dropdown clearfix active">
                                    <a href="shop-product-list.html" class="collapsed"><i class="fa fa-angle-right"></i>
                                        Shoes </a>
                                    <ul class="dropdown-menu" style="display:block;">
                ...
                <div class="col-md-9 col-sm-7">
                    <div class="product-page">
                        <form action="{{ url('productspost', $products->id) }}" method="POST">
                            <div class="row">
                                <div class="col-md-6 col-sm-6">
                                    <div class="product-main-image">
                                        <img src="/products/{{ $products->image }}" alt="Cool green dress with red bell"
                                            class="img-responsive" data-BigImgsrc="/products/{{ $products->image }}">
                                    </div>
                                    <div class="product-other-images">
                                        ...
                                        <a href="/assets/pages/img/products/model4.jpg" class="fancybox-button"
                                            rel="photos-lib"><img alt="Berry Lace Dress"
                                                src="/assets/pages/img/products/model4.jpg"></a>
                                        <a href="/assets/pages/img/products/model5.jpg" class="fancybox-button"
                                            rel="photos-lib"><img alt="Berry Lace Dress"
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="price-availability-block clearfix">
                                        <div class="price">
                                            <strong><span>$</span>{{ $products->price }}</strong>
                                            <em>$<span>900.00</span></em>
                                        </div>
